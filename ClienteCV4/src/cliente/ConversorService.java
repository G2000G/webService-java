 ...
 * 
 */
@WebServiceClient(name = "ConversorService", targetNamespace = "http://control/", wsdlLocation = "http://localhost:13000/conversor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSORSERVICE_QNAME = new QName("http://control/", "ConversorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:13000/conversor?wsdl");
    ...
    public Conversor getConversorPort() {
        return super.getPort(new QName("http://control/", "ConversorPort"), Conversor.class);
    }
    ...
    public Conversor getConversorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://control/", "ConversorPort"), Conversor.class, features);
    }
